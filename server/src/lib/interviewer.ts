...
import { STAR_METHOD_QUESTIONS } from "../constants/questions";
import { callOpenAi } from "../openai";
import { RESUME_PROMPT } from "../constants/prompt";
...
export class Interviewer {
  ...
  public async init() {
    this.questions = [
      ...
      "Great. So to give you a bit of background about myself, I've been working in HR for over a decade. I started my career in HR when I graduated from the University of Washington, but I quickly transitioned to a more focused role in technical recruitment, and I've been at Company Inc. for two years now where I've been able to collaborate with the other teams and identify candidates who align who I think would fit well here. So, why don't you tell me a little about yourself before we get started?",
      FOLLOW_UP_QUESTION,
      // Question about resume
      await callOpenAi(this.chain, RESUME_PROMPT),
    ];

    for (let i = 0; i < this.numQuestions; i++) {
      this.questions.push(this.questions[i], FOLLOW_UP_QUESTION);
    }
  }
